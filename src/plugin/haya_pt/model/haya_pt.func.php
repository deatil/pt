...
function haya_pt_plugin_upload_dir($dir = '') {
    $upload_dir = APP_PATH . 'upload/';
...
function haya_pt_plugin_torrent($torrent = '') {
    $torrent_dir = haya_pt_plugin_upload_dir('torrent');
    
    !is_dir($torrent_dir) && mkdir($torrent_dir, 0766);
